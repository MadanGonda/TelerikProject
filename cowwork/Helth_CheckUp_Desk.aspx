...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table style="width: 109%; height: 512px;" >
        <tr>
            ...
            <td class="style93">
                <telerik:RadButton ID="RadButton1" runat="server" Text="Submit Info" 
        ...
        <tr>
            ...
            <td class="style77">
                ...
                <telerik:RadAjaxPanel ID="RadAjaxPanel2" runat="server" height="51px" 
                    width="300px">
                        ...
                        <ContentTemplate>
                            <table style="width:100%;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <telerik:RadComboBox ID="Rad_Combo_Duration" Runat="server" AutoPostBack="True">
                                        </telerik:RadComboBox>
                                    </td>
                                    <td>
                                        &nbsp;</td>
            ...
            <td class="style80">
               ...
               <telerik:RadAjaxPanel ID="RadAjaxPanel3" runat="server" height="61px" 
                    width="300px">  
