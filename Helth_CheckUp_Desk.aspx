<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage1.master" AutoEventWireup="true" CodeFile="Helth_CheckUp_Desk.aspx.cs" Inherits="Helth_CheckUp_Desk" %>

<%@ Register assembly="Telerik.Web.UI" namespace="Telerik.Web.UI" tagprefix="telerik" %>

<%@ Register src="Sign_In_WebUserControl.ascx" tagname="Sign_In_WebUserControl" tagprefix="uc1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table style="width: 109%; height: 512px;" >
        <tr>
            <td class="style100">
                <telerik:RadButton ID="RadButton7" runat="server" Text="View Profile" 
                    onclick="RadButton7_Click">
                </telerik:RadButton>
                </td>
            <td class="style101">
                &nbsp;</td>
            <td class="style102">
                ...
                <asp:Label ID="lbl_wellcome" runat="server"></asp:Label>
                <asp:Label ID="Lbl_password" runat="server" Visible="False"></asp:Label>
                <asp:Label ID="lbl_User_ID" runat="server" Visible="False"></asp:Label>
                </td>
            <td class="style93">
                <telerik:RadButton ID="RadButton1" runat="server" Text="Submit" 
                    ButtonType="LinkButton" onclick="RadButton1_Click" Visible="False" >
                </telerik:RadButton>
                </td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="style76">
                <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" height="10px" 
                    width="300px" >
            ...
            <td class="style77">
                ...
                <telerik:RadAjaxPanel ID="RadAjaxPanel2" runat="server" height="25px" 
                    width="300px">
                            ...
                            <table style="width:100%;">
                                ...
                                <tr>
                                    <td>
                                        &nbsp;</td>
                                    <td class="style111">
                                        <telerik:RadButton ID="Rad_Comman_Diseases" runat="server" Text="Submit" 
                                            onclick="Rad_Comman_Diseases_Click">
                                        </telerik:RadButton>
                                    </td>
                                    <td>
                                        &nbsp;</td>
            ...
            <td class="style106">
                <telerik:RadWindow ID="RadWindow7" runat="server" Modal="True" Behaviors="Close">
                    <ContentTemplate>
                        <table style="width:100%;">
                            <tr>
                                <td>
                                ...
                                <td class="style133" colspan="2">
                                    <asp:Label ID="Label14" runat="server" Text="Your Session Is Expired !"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td class="style133">
                                    &nbsp;</td>
                                <td class="style134">
                                    <telerik:RadButton ID="RadButton8" runat="server" onclick="RadButton8_Click" 
                                        Text="Sign In">
                                    </telerik:RadButton>
                                </td>
                                <td>
        ...
        <tr>
            <td class="style96">
                <uc1:Sign_In_WebUserControl ID="Sign_In_WebUserControl1" runat="server" />
            </td>
            <td class="style97"> 
            ...
            <td class="style99">
                <telerik:RadAjaxPanel ID="RadAjaxPanel6" runat="server" height="28px" 
                    width="329px" HorizontalAlign="NotSet">
                            ...
                            <table style="width: 89%; height: 100px;">
                                ...
                                <tr>
                                    <td class="style117">
                                        &nbsp;</td>
                                    <td>
                                        <telerik:RadButton ID="Rad_Body_Parts" runat="server" 
                                            onclick="Rad_Body_Parts_Click" Text="Submit">
                                        </telerik:RadButton>
                                    </td>
                                    <td>
                                        &nbsp;</td>
