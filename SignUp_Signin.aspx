<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage1.master" AutoEventWireup="true"
    CodeFile="SignUp_Signin.aspx.cs" Inherits="SignUp" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table style="width: 100%; height: 487px;">
        <tr>
            ...
            <td class="style172">
                <asp:Label ID="Label44" runat="server" Text="Hi ,"></asp:Label>&nbsp;
                <asp:Label ID="Label45" runat="server" Text="Label"></asp:Label>&nbsp;
                <asp:Label ID="Label46" runat="server" Text="Label" Visible="False"></asp:Label>
            </td>
                 <td class="style174">
                     <telerik:RadButton ID="RadButton1" runat="server" Text="Update Profile" 
                         onclick="RadButton1_Click">
                     </telerik:RadButton>
            </td>
            <td class="style177">
                <telerik:RadButton ID="RadButton8" runat="server" Text="Change Password" 
                    onclick="RadButton8_Click" >
                </telerik:RadButton>
            </td>
            <td class="style178">
                <telerik:RadButton ID="RadButton9" runat="server" Text="Delete Profile" 
                    onclick="RadButton9_Click">
                </telerik:RadButton>
            </td>
        </tr>
        <tr>
            ...
            <td class="style172" align="left">
                <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="339px" Style="margin-left: 0px"
                    ...
                    <telerik:RadMultiPage ID="RadMultiPage1" runat="server" SelectedIndex="0" Width="109%"
                        ...
                        <telerik:RadPageView ID="RadPageView1" runat="server" Height="16px" 
                            ...
                            <table style="width: 99%; height: 428px">
                                <tr>
                                    ...
                                    <td class="style167">
                                        <telerik:RadTextBox ID="Rad_Txt_FName" runat="server" EmptyMessage="First Name" Width="125px" MaxLength="29">
                                        </telerik:RadTextBox>
                                ...
                                <tr>
                                    ...
                                    <td class="style135">
                                        <telerik:RadTextBox ID="Rat_Txt_Lname" runat="server" EmptyMessage="Last Name" Width="125px" MaxLength="29">
                                        </telerik:RadTextBox>
                                ...
                                <tr>
                                    ...
                                    <td class="style64">
                                        <telerik:RadTextBox ID="Rad_Txt_Email" runat="server" EmptyMessage="Email Address" MaxLength="29"
                                            Width="125px">
                                        </telerik:RadTextBox>
                                ...
                                <tr>
                                    ...
                                    <td class="style90">
                                        <telerik:RadDatePicker ID="Rad_Date_time_picker" runat="server" AutoPostBack="True"
                                            Culture="en-US" MaxDate="2000-12-31" MinDate="1900-01-01">
                                ...
                                <tr>
                                    ...
                                    <td class="style142">
                                        <telerik:RadButton ID="Radio_Gender_male" runat="server" 
                                            ButtonType="ToggleButton" GroupName="Gender" Text="Male" ToggleType="Radio">
                                        </telerik:RadButton>
                                        <telerik:RadButton ID="Radio_Gender_female" runat="server" 
                                            ButtonType="ToggleButton" GroupName="Gender" Text="female" ToggleType="Radio">
                                        </telerik:RadButton>
                                ...
                                <tr>
                                    ...
                                    <td class="style82">
                                        <telerik:RadComboBox ID="Rad_Combo_Country" runat="server" AutoPostBack="True" OnSelectedIndexChanged="Rad_Combo_Country_SelectedIndexChanged">
                                        </telerik:RadComboBox>
                                ...
                                <tr>
                                    ...
                                    <td class="style131">
                                        <telerik:RadComboBox ID="RadComboBox_State" Runat="server" Height="80px">
                                        </telerik:RadComboBox>
                                ...
                                <tr>
                                    ...
                                    <td class="style145">
                                        <telerik:RadTextBox ID="Rad_Txt_Address" runat="server" TextMode="MultiLine" Width="195px"
                                            EmptyMessage="Enter Your Address" MaxLength="139">
                                        </telerik:RadTextBox>
                        ...
                        <telerik:RadPageView ID="RadPageView2" runat="server">
                            ...
                            <table style="width: 100%;">
                                <tr>
                                    ...
                                    <td class="style75">
                                        <telerik:RadComboBox ID="Rad_Combo_Blood_Group" runat="server" AutoPostBack="True">
                                        </telerik:RadComboBox>
                        ...
                        <telerik:RadPageView ID="RadPageView3" runat="server" Height="50px">
                            ...
                            <table style="width: 100%; height: 106px;">
                                ...
                                <tr>
                                    ...
                                    <td class="style155">
                                        <telerik:RadTextBox ID="Txt_Medical_History" runat="server" 
                                            TextMode="MultiLine" MaxLength="139">
                                        </telerik:RadTextBox>
                                    </td>
                                    <td class="style169">
                                        &nbsp;
                                ...
                                <tr>
                                    <td class="style159">
                                        <asp:Label ID="Label20" runat="server" Text="Password :" Visible="False"></asp:Label>
                                    </td>
                                    <td class="style155">
                                        <telerik:RadTextBox ID="RadTxtPassword" runat="server" TextMode="Password" 
                                            MaxLength="29" Visible="False">
                                        </telerik:RadTextBox>
                                        <asp:Label ID="Label33" runat="server" ForeColor="#FF9999" Text="*" 
                                            Visible="False"></asp:Label>
                                    </td>
                                    <td class="style169">
                                        &nbsp;
                                ...
                                <tr>
                                    <td class="style159">
                                        <asp:Label ID="Label21" runat="server" Text="Confirm Password :" 
                                            Visible="False"></asp:Label>
                                    </td>
                                    <td class="style155">
                                        ...
                                        <asp:Label ID="Label34" runat="server" ForeColor="#FF9966" Text="*" 
                                            Visible="False"></asp:Label>
                                    </td>
                                    <td class="style169">
                                        &nbsp;
                            ...
                            <br />
                            <br />
                            <telerik:RadWindow ID="RadWindow1" runat="server" Height="146px" Modal="True" 
                                Width="288px" Behaviors=Close>
                                <ContentTemplate>
                                    <table style="width: 97%; height: 78px;">
                                        <tr>
                                            <td>
                                                &nbsp;</td>
                                            <td class="style170" colspan="2">
                                                <asp:Label ID="Label47" runat="server" Text="Your Data Is Updated ."></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td class="style170">
                                                &nbsp;</td>
                                            <td class="style171">
                                                <telerik:RadButton ID="RadButton7" runat="server" Text="OK" 
                                                    onclick="RadButton7_Click1">
                                                </telerik:RadButton>
                                            </td>
                                            <td>
                                                &nbsp;</td>
        ...
        <tr>
            ...
            <td class="style172">
                &nbsp;
                                        <asp:Button ID="btn_data_send" runat="server" Text="Update"  
                                            OnClientClick="return validation2()" 
                    onclick="btn_data_send_Click" style="height: 26px"/> &nbsp;
